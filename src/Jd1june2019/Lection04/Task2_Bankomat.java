...
//                } else {
    ...
    public void addMoney(int b20, int b50, int b100) {
        ...
        sumMoneyBankomat += abs(b20) * 20 + abs(b50) * 50 + abs(b100) * 100;
    ...
    public void delMoney(int nominalBanknot[][]) {
        for (int i = 0; i < nominalBanknot.length; i++) {
            ...
            sumMoneyBankomat -= nominalBanknot[i][0] * nominalBanknot[i][1];
        }
    ...
    public int getSumMoneyBankomat() {
        return sumMoneyBankomat;
    }//геттер
