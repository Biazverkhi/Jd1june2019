...
public class Task2_Test {
    public static void main(String[] args) {
        Task2_Bankomat bankomat = new Task2_Bankomat(20, 2, 50, 5, 100, 10);// ввод массива банка банкомата с данными в следующем порядке: начиная с меньшего номинала: номинал и количество, номинал и количество и т.д.
